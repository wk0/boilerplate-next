...
const mintPhases = [
  {
    startTimestamp: new Date('2022-05-01T22:00:00+0000').getTime(),
    pricePerToken: 0,
    name: 'PREMINT',
    merkleRoot: null,
    merkleTree: null,
  ...
  {
    startTimestamp: new Date('2022-05-04T21:00:00+0000').getTime(),
  ...
  {
    startTimestamp: new Date('2022-05-04T21:02:00+0000').getTime(),
  ...
  {
    startTimestamp: new Date('2022-05-04T21:04:00+0000').getTime(),
  ...
  {
    startTimestamp: new Date('2022-05-04T21:06:00+0000').getTime(),
