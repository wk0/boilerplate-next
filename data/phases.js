...
const mintPhases = [
  ...
  {
    startTimestamp: new Date('2022-05-01T10:00:00').getTime(),
  ...
  {
    startTimestamp: new Date('2022-05-01T10:30:00').getTime(),
  ...
  {
    startTimestamp: new Date('2022-05-01T11:00:00').getTime(),
  ...
  {
    startTimestamp: new Date('2022-05-01T12:17:50').getTime(),
    pricePerToken: 0,
    merkleTree: null,
    merkleRoot: null,
    allowedMints: {},
